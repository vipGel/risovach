...
class PainterEditRoute extends _i6.PageRouteInfo<PainterEditRouteArgs> {
  PainterEditRoute({
    ...
    List<_i6.PageRouteInfo>? children,
         ...
         args: PainterEditRouteArgs(key: key, id: id),
         rawPathParams: {'id': id},
  ...
  static _i6.PageInfo page = _i6.PageInfo(
    ...
    builder: (data) {
      ...
      final args = data.argsAs<PainterEditRouteArgs>(
        orElse: () => PainterEditRouteArgs(id: pathParams.getString('id')),
      );
      return _i2.PainterEditPage(key: args.key, id: args.id);
    },
  );
}

class PainterEditRouteArgs {
  const PainterEditRouteArgs({this.key, required this.id});
  ...
  @override
  String toString() {
    return 'PainterEditRouteArgs{key: $key, id: $id}';
  }
